...
#include "MaterialLib/PorousMedium/Tortuosity/createTortuosityModel.h"
    ...
    MeshLib::Mesh& mesh, BaseLib::ConfigTree const& porous_medium_configs)
{
    ...
    std::vector<std::unique_ptr<MaterialLib::PorousMedium::Porosity>>
        porosity_models;
    std::vector<std::unique_ptr<MaterialLib::PorousMedium::Tortuosity>>
        tortuosity_models;
         ...
         porous_medium_configs.getConfigSubtreeList("porous_medium"))
    {
        ...
        auto const& porosity_conf =
            //! \ogs_file_param{prj__processes__process__HC__porous_medium__porous_medium__porosity}
        ...
        // Parameter to describe tortuosity of porous medium
        auto const& tortuosity_conf =
            //! \ogs_file_param{prj__processes__process__HC__porous_medium__porous_medium__tortuosity}
            porous_medium_config.getConfigSubtree("tortuosity");
        tortuosity_models.emplace_back(
            MaterialLib::PorousMedium::createTortuosityModel(tortuosity_conf));
        ...
        auto const& permeability_conf =
            //! \ogs_file_param{prj__processes__process__HC__porous_medium__porous_medium__permeability}
        ...
        auto const& storage_conf =
            //! \ogs_file_param{prj__processes__process__HC__porous_medium__porous_medium__storage}
    ...
    BaseLib::reorderVector(tortuosity_models, mat_ids);
