...
public:
                  ...
                  std::vector<double>& local_b_data) override
    {
        ...
        for (std::size_t ip(0); ip < n_integration_points; ip++)
        {
            ...
            // should be taken from fluid properties
            ...
            auto const solute_diffusion_coefficient =
                _process_data.solute_diffusion_coefficient(t, pos)[0];
            ...
            auto const tortuosity =
                _process_data.porous_media_properties.getTortuosity(t, pos)
                    .getValue(0.0);

            double const solute_diffusivity =
                /*thermal_conductivity_solid * (1 - porosity) +*/
                 solute_diffusion_coefficient * porosity * tortuosity;
            ...
            GlobalDimVectorType const velocity =
                -perm_over_visc * (dNdx * p_nodal_values - density_water_C * b);

            double const velocity_magnitude = velocity.norm();
            GlobalDimMatrixType const& I(
                GlobalDimMatrixType::Identity(GlobalDim, GlobalDim));
            GlobalDimMatrixType solute_dispersivity =
            ...
            auto const hydrodynamic_solute_dispersion =
                solute_diffusivity * I + solute_dispersivity;
            ...
            // matrix assembly
            Ktt.noalias() +=
                (dNdx.transpose() * hydrodynamic_solute_dispersion * dNdx +
            ...
            Mtt.noalias() += w * N.transpose() * N;
            Mpp.noalias() += w * N.transpose() * specific_storage * N;
            Bp += w * density_water_C * dNdx.transpose() * perm_over_visc * b;
