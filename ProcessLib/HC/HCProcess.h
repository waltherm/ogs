 ...
 * ## Process Coupling
 *
 * The advective term of the solute adv-disp equation is given by the confined
 * groundwater flow process, i.e., the solute adv-disp depends on darcy velocity
 * of the groundwater flow process. On the other hand the concentration
